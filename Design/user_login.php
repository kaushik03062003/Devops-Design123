    ...
    <div class="max-w-md w-full mx-auto mt-16">
        <div class="glass-effect rounded-lg shadow-xl p-8">
            <h2 class="text-3xl font-bold mb-6 flex items-center justify-center">
                <i class="fas fa-sign-in-alt text-indigo-400 mr-3"></i>
                User Login
            </h2>
            <?php if ($error): ?>
            ...
            <form method="post" class="space-y-6">
                ...
                <div class="input-icon">
                    ...
                    <input type="password" name="password" placeholder="Password" required class="w-full p-3 bg-gray-800 border border-gray-700 rounded-md text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-400" autocomplete="current-password">
                </div>
            ...
            <p class="text-center mt-4 text-gray-300">
                Don't have an account? <a href="register.php" class="text-indigo-400 hover:underline">Register</a>
            </p>
        </div>
    </div>
