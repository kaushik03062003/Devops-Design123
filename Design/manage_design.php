...
<head>
    ...
    <title>Admin Designs Management</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="add_design.php" class="hover:text-indigo-400 transition"><i class="fas fa-users mr-1"></i> add_design</a>
                    <a href="manage_design.php" class="hover:text-indigo-400 transition"><i class="fas fa-paint-brush mr-1"></i> Mange Design</a>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php while($row = $res->fetch_assoc()): ?>
                    <div class="design-card bg-gray-800 rounded-lg overflow-hidden glass-effect p-4">
                        ...
                        <p class="text-gray-300 text-sm"><?php echo htmlspecialchars($row['description']); ?></p>
                    </div>
                <?php endwhile; ?>
            </div>
        </div>
